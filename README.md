...
(0)
First you need to get the original DOOM and DOOM II WAD files. Do not buy the new re-releases, they have PC culture all over them. Find the OG true files.
...
cd  D:\GAMES\
wget https://netix.dl.sourceforge.net/project/prboom-plus/prboom-plus/2.5.1.4/prboom-plus-2.5.1.4-win32.zip -OutFile prboom_win32.zip
# unzip, had to do it via WinRAR
# copy your DOOM and DOOM II WAD files!
# I have one just laying around
cp .\DOOM.WAD prboom_win32\prboom-plus-2.5.1.4
```

On Linux the installation process is more involved and requires compilation.
Please see the INSTALL file. Also it varies per Linux distribution.

(2)
Now launching your DOOM games is as easy as:

In PowerShell

```powershell
# go to your game folder
cd prboom_win32\prboom-plus-2.5.1.4
# launche the OG DOOM
